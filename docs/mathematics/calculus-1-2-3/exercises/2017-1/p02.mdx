...
a) $\sum_{n=0}^{\infty} \frac{(n!)^2}{(2 n)!}$

b) $\sum_{n=0}^{\infty} \frac{1}{4 n+1}$

c) $\sum_{n=1}^{\infty} \frac{\ln (\mathrm{n})}{n+2}$

d) $\sum_{n=2}^{\infty} \frac{n^3+4 n}{n^4-8}$
</div>
...
<Disqus
  url="https://crow-rojas.github.io/apuntes-fundamentals/docs/mathematics/calculus-1-2-3/exercises/2017-1/p02"
  identifier="docs/mathematics/calculus-1-2-3/exercises/2017-1/p02"
  title="2017-1 Cálculo I, II y III - Pregunta 02"
/>
